...
# Welcome
clear
print_header "KoterOS - Simplified Installation"
echo ""
echo -e "${BLUE}Welcome! This installer will set up KoterOS with sensible defaults.${NC}"
